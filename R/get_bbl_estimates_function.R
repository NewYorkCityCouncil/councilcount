#' Function to produce a dataframe containing BBL-level population estimates for a specified year
#'
#' @import tidyverse
#' @import dplyr
#' @param year (string). The desired year for BBL-level estimates. The most recent year available will populate if left NULL.
#' @return Table with population estimates by BBL, as well as multiple geography columns for aggregation. Avoid using estimates for individual BBLs—the more aggregation, the less error.
#' @export
#'
